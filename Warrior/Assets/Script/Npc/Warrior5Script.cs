...
public class Warrior5Script : MonoBehaviour
{
    public GameObject Player;
    public float Warrior5Hp = 500;
    ...
    int r;
    public Text Warrior5HpText;
    public Image Warrior5HpImage;
    bool Ifront;
    bool Iback;
    public bool IFreeze;
    public bool IDead;
    ...
    void Update()
    {
        ...
        atk = (int)(10 + (500 - Warrior5Hp) * 0.2f);
        Warrior5HpText.text = Warrior5Hp.ToString();
    ...
    public void AddWarrior5Hp(float value)
    {
        Warrior5Hp += value;
        Warrior5Hp = Mathf.Clamp(Warrior5Hp, 0, 500f);
    }
    public void DecreaseWarrior5Hp(float value)
    {
        Warrior5Hp -= value;
        if (Warrior5Hp <= 0)
        {
    ...
    IEnumerator ShowWarrior5Hp()
    {
        yield return new WaitForSeconds(0.1f);
        float Health = Warrior5Hp;
        while (true)
        {
            if (Health < Warrior5Hp)
            {
                Health += 1f;
            }
            else
            ...
            Warrior5HpImage.fillAmount = (int)Health / 500f;
    ...
    public void NpcUseItem()
    {
        ...
        switch (r)
        {
            ...
            case 7:
                ...
                m.GetComponent<MapScript>().dic[GetComponentInParent<Warrior5Script>().Name] += 50;
                break;
            case 8:
                MatrixObj.SetActive(true);
                Invoke("FalseMatrix", 5f);
                m.GetComponent<MapScript>().dic[GetComponentInParent<Warrior5Script>().Name] += 20;
                break;
            case 9:
                Iparse = true;
