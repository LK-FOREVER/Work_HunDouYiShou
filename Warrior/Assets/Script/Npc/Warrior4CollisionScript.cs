    ...
    public void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (!this.GetComponentInParent<Warrior4Script>().Iparse)
        {
            ...
            if (collision.gameObject.tag == "Player")
            {
                ...
                collision.GetComponentInParent<PlayerScript>().rig.AddForce(this.GetComponentInParent<Warrior4Script>().d * 15000 * Time.deltaTime); //���Է�ʩ�����������������ģ���ֹ��Ҿ�ֹ
                ...
                GetComponentInParent<Warrior4Script>().ColiEff.SetActive(true);                //ײ����Ч
            ...
            if (collision.gameObject.name == "PlayerDefendObject")
            {
                ...
                this.GetComponentInParent<Warrior4Script>().rig.AddForce(Defendd * 10000 * Time.deltaTime); //���Է�ʩ�����������������ģ���ֹ��Ҿ�ֹ
        ...
        if (collision.gameObject.tag == "AddBlood" && GetComponentInParent<Warrior4Script>().Warrior4Hp != 200f)
        {
            ...
            if (r > GetComponentInParent<Warrior4Script>().Player.GetComponent<PlayerScript>().B1 && r < GetComponentInParent<Warrior4Script>().Player.GetComponent<PlayerScript>().B2)
            {
                ...
                GetComponentInParent<Warrior4Script>().BloodTxt.gameObject.SetActive(true);      //��Ѫ�ı���Ч
        ...
        if (collision.gameObject.tag == "Boom")
        {
            ...
            GetComponentInParent<Warrior4Script>().BloodTxt.color = new Color(1f,1f, 1f);
            GetComponentInParent<Warrior4Script>().InvokeFalseBloodTxt();
            Destroy(collision.gameObject);
