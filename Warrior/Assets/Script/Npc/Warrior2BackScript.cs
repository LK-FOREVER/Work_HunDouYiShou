...
public class Warrior2BackScript : MonoBehaviour
{
    ...
    public void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (!this.GetComponentInParent<Warrior2Script>().Iparse)
        {
            if (collision.gameObject.tag == "Obstacle")
            {
                ...
                //print("��ײ��");
                transform.parent.GetComponentInParent<Warrior2Script>().rig.AddForce(transform.parent.GetComponentInParent<Warrior2Script>().d * 30000 * Time.deltaTime);
            ...
            if (collision.gameObject.name == "PlayerDefendObject")
            {
                ...
                this.GetComponentInParent<Warrior2Script>().BloodTxt.color = new Color(1f,1f, 1f);
