...
public class Warrior6CollisionScript : MonoBehaviour
{
    ...
    {
        var mapScript = GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>();
        string key = GetComponentInParent<Warrior6Script>().Name;
        ...
        if (!this.GetComponentInParent<Warrior6Script>().Iparse)
        {
            if (collision.gameObject.tag == "Obstacle")
            {
                ...
                this.GetComponentInParent<Warrior6Script>().TargetPos = new Vector3(x, y, 0);
            }

            if (collision.gameObject.name == "frontObject")
            {

                GetComponentInParent<Warrior6Script>().audio.clip = GetComponentInParent<Warrior6Script>().acilp[2];
                GetComponentInParent<Warrior6Script>().audio.Play();
                collision.GetComponentInParent<PlayerScript>().rig.AddForce(this.GetComponentInParent<Warrior6Script>().d * 15000 * Time.deltaTime); //���Է�ʩ�����������������ģ���ֹ��Ҿ�ֹ

                collision.GetComponentInParent<PlayerScript>().rig.drag = 6f;
                collision.GetComponentInParent<PlayerScript>().rig.angularDrag = 6f;
                Ifront = true;
                //GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().Warriorpoint[GetComponentInParent<Warrior6Script>().index] += 25;
                GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic[GetComponentInParent<Warrior6Script>().Name] += 25;
                GetComponentInParent<Warrior6Script>().ColiEff.SetActive(true);                //ײ����Ч
            ...
            if (collision.gameObject.name == "frontObject1")
            {
                GetComponentInParent<Warrior6Script>().audio.clip = GetComponentInParent<Warrior6Script>().acilp[2];
                GetComponentInParent<Warrior6Script>().audio.Play();
                collision.GetComponentInParent<Warrior1Script>().rig.AddForce(this.GetComponentInParent<Warrior6Script>().d * 15000 * Time.deltaTime);
            ...
            if (collision.gameObject.name == "frontObject2")
            {
                GetComponentInParent<Warrior6Script>().audio.clip = GetComponentInParent<Warrior6Script>().acilp[2];
                GetComponentInParent<Warrior6Script>().audio.Play();
                collision.GetComponentInParent<Warrior2Script>().rig.AddForce(this.GetComponentInParent<Warrior6Script>().d * 15000 * Time.deltaTime);
            ...
            if (collision.gameObject.name == "frontObject3")
            {
                GetComponentInParent<Warrior6Script>().audio.clip = GetComponentInParent<Warrior6Script>().acilp[2];
                GetComponentInParent<Warrior6Script>().audio.Play();
                collision.GetComponentInParent<Warrior3Script>().rig.AddForce(this.GetComponentInParent<Warrior6Script>().d * 15000 * Time.deltaTime);
            ...
            if (collision.gameObject.name == "frontObject4")
            {
                GetComponentInParent<Warrior6Script>().audio.clip = GetComponentInParent<Warrior6Script>().acilp[2];
                GetComponentInParent<Warrior6Script>().audio.Play();
                collision.GetComponentInParent<Warrior4Script>().rig.AddForce(this.GetComponentInParent<Warrior6Script>().d * 15000 * Time.deltaTime);
            ...
            if (collision.gameObject.name == "frontObject5")
            {
                GetComponentInParent<Warrior6Script>().audio.clip = GetComponentInParent<Warrior6Script>().acilp[2];
                GetComponentInParent<Warrior6Script>().audio.Play();
                collision.GetComponentInParent<Warrior5Script>().rig.AddForce(this.GetComponentInParent<Warrior6Script>().d * 15000 * Time.deltaTime);
            ...
            if (collision.gameObject.name == "frontObject6")
            {
                GetComponentInParent<Warrior6Script>().audio.clip = GetComponentInParent<Warrior6Script>().acilp[2];
                GetComponentInParent<Warrior6Script>().audio.Play();
                collision.GetComponentInParent<Warrior6Script>().rig.AddForce(this.GetComponentInParent<Warrior6Script>().d * 15000 * Time.deltaTime);
            ...
            if (collision.gameObject.name == "backObject")
            {
                ...
                {
                    //GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().Warriorpoint[GetComponentInParent<Warrior6Script>().index] += 100;
                    GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic[GetComponentInParent<Warrior6Script>().Name] += 100;
                }
                else
                {
                    //GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().Warriorpoint[GetComponentInParent<Warrior6Script>().index] += 50;
                    GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic[GetComponentInParent<Warrior6Script>().Name] += 50;
                }
            ...
            {
                GetComponentInParent<Warrior6Script>().audio.clip = GetComponentInParent<Warrior6Script>().acilp[3];
                GetComponentInParent<Warrior6Script>().audio.Play();
                collision.GetComponentInParent<Warrior1Script>().rig.AddForce(this.GetComponentInParent<Warrior6Script>().d * 15000 * Time.deltaTime);
            ...
            if (collision.gameObject.name == "backObject2")
            {
                ...
                if (collision.GetComponentInParent<Warrior2Script>().Ishield == true && collision.GetComponentInParent<Warrior2Script>().ShieldHp == 0)//�ƶ�
                {
            ...
            if (collision.gameObject.name == "PlayerDefendObject")
            {
                ...
                //this.GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic[GetComponentInParent<Warrior6Script>().Name] += 50;
                ...
                this.GetComponentInParent<Warrior6Script>().BloodTxt.color = new Color(1f,1f, 1f);
                this.GetComponentInParent<Warrior6Script>().InvokeFalseBloodTxt();
                //�����ж���ӷ�
                if (collision.transform.parent.name == "Player")
                {
                    GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic["���"] += 50;
                }
                if (collision.transform.parent.name == "Warrior1(Clone)")
                {
                    GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic[collision.transform.parent.GetComponent<Warrior1Script>().Name] += 50;
                }
                if (collision.transform.parent.name == "Warrior2(Clone)")
                {
                    GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic[collision.transform.parent.GetComponent<Warrior2Script>().Name] += 50;
                }
                if (collision.transform.parent.name == "Warrior3(Clone)")
                {
                    GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic[collision.transform.parent.GetComponent<Warrior3Script>().Name] += 50;
                }
                if (collision.transform.parent.name == "Warrior4(Clone)")
                {
                    GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic[collision.transform.parent.GetComponent<Warrior4Script>().Name] += 50;
                }
                if (collision.transform.parent.name == "Warrior5(Clone)")
                {
                    GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic[collision.transform.parent.GetComponent<Warrior5Script>().Name] += 50;
                }
                if (collision.transform.parent.name == "Warrior6(Clone)")
                {
                    GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic[collision.transform.parent.GetComponent<Warrior6Script>().Name] += 50;
                }
            }
        ...
        if (collision.gameObject.tag == "AddBlood" && GetComponentInParent<Warrior6Script>().Warrior6Hp != 200f)
        {
            int r = Random.Range(1, 21);
            if (r > GetComponentInParent<Warrior6Script>().Player.GetComponent<PlayerScript>().B1 && r < GetComponentInParent<Warrior6Script>().Player.GetComponent<PlayerScript>().B2)
            {
                GetComponentInParent<Warrior6Script>().AddWarrior6Hp(10);
                GetComponentInParent<Warrior6Script>().BloodTxt.gameObject.SetActive(true);      //��Ѫ�ı���Ч
                GetComponentInParent<Warrior6Script>().BloodTxt.text = "+10";
                GetComponentInParent<Warrior6Script>().BloodTxt.color = new Color(0.427f, 0.980f, 0.302f);
                GetComponentInParent<Warrior6Script>().InvokeFalseBloodTxt();
        ...
        {
            GetComponentInParent<Warrior6Script>().audio.clip = GetComponentInParent<Warrior6Script>().acilp[1];
            GetComponentInParent<Warrior6Script>().audio.Play();
            GetComponentInParent<Warrior6Script>().DecreaseWarrior6Hp(20);
            GetComponentInParent<Warrior6Script>().BloodTxt.gameObject.SetActive(true);      //��Ѫ�ı���Ч
            GetComponentInParent<Warrior6Script>().BloodTxt.text = "-20";
            GetComponentInParent<Warrior6Script>().BloodTxt.color = new Color(0.427f, 0.980f, 0.302f);
            GetComponentInParent<Warrior6Script>().InvokeFalseBloodTxt();
            Destroy(collision.gameObject);
            //m.GetComponent<MapScript>().Warriorpoint[index] += 5;
        ...
        {
            int r = Random.Range(1, 21);
            if (r > GetComponentInParent<Warrior6Script>().Player.GetComponent<PlayerScript>().T1 && r < GetComponentInParent<Warrior6Script>().Player.GetComponent<PlayerScript>().T2)
            {
                GetComponentInParent<Warrior6Script>().DecreaseWarrior6Hp(10);
                GetComponentInParent<Warrior6Script>().BloodTxt.gameObject.SetActive(true);      //��Ѫ�ı���Ч
                GetComponentInParent<Warrior6Script>().BloodTxt.text = "-10";
                GetComponentInParent<Warrior6Script>().BloodTxt.color = new Color(0.427f, 0.980f, 0.302f);
                GetComponentInParent<Warrior6Script>().InvokeFalseBloodTxt();
        ...
        if (collision.gameObject.tag == "Defend" || collision.gameObject.tag == "Hammer" || collision.gameObject.tag == "HandBomb" || collision.gameObject.tag == "Hook" || collision.gameObject.tag == "Knife" || collision.gameObject.tag == "Light" || collision.gameObject.tag == "Magnet" || collision.gameObject.tag == "Matrix" || collision.gameObject.tag == "PMove" || collision.gameObject.tag == "Shoot")
        {
            ...
            if (GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic == null || !GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic.ContainsKey(GetComponentInParent<Warrior6Script>().Name))
                return;
            if (collision.gameObject.tag == "Defend")
            {
                GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic[GetComponentInParent<Warrior6Script>().Name] += 20;
            }
    ...
    {
        GetComponentInParent<Warrior6Script>().Player.GetComponent<PlayerScript>().MonsterEff.SetActive(false);
    }
}
