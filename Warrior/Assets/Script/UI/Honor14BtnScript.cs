...
public class Honor14BtnScript : MonoBehaviour
{
    ...
    public void GetCoin14()
    {
        ...
        P_Get = PlayerPrefs.GetInt(SdkScript.nickname + "Get14", 0);          //�ж��Ƿ���ȡ������
        P_Get = 2;
        PlayerPrefs.SetInt(SdkScript.nickname + "get14", 1);
        PlayerPrefs.SetInt(SdkScript.nickname + "Get14", P_Get);
        h.getnum--;
