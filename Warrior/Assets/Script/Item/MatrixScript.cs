...
public class MatrixScript : MonoBehaviour
{
    ...
    {
        if ((collision.gameObject.tag == "Npc"|| collision.gameObject.name == "Player") && collision.gameObject != this.transform.parent)
        {
            //命中掉血
            ...
            {
                collision.GetComponent<Warrior1Script>().DecreaseWarrior1Hp(5);

                collision.GetComponentInParent<Warrior1Script>().BloodTxt.gameObject.SetActive(true);      //掉血文本特效
                collision.GetComponentInParent<Warrior1Script>().BloodTxt.text = "-" + "5";
            ...
            {
                collision.GetComponent<Warrior2Script>().DecreaseWarrior2Hp(5);

                collision.GetComponentInParent<Warrior2Script>().BloodTxt.gameObject.SetActive(true);      //掉血文本特效
                collision.GetComponentInParent<Warrior2Script>().BloodTxt.text = "-" + "5";
            ...
            {
                collision.GetComponent<Warrior3Script>().DecreaseWarrior3Hp(5);

                collision.GetComponentInParent<Warrior3Script>().BloodTxt.gameObject.SetActive(true);      //掉血文本特效
                collision.GetComponentInParent<Warrior3Script>().BloodTxt.text = "-" + "5";
            ...
            {
                collision.GetComponent<Warrior4Script>().DecreaseWarrior4Hp(5);

                collision.GetComponentInParent<Warrior4Script>().BloodTxt.gameObject.SetActive(true);      //掉血文本特效
                collision.GetComponentInParent<Warrior4Script>().BloodTxt.text = "-" + "5";
            ...
            {
                collision.GetComponent<Warrior5Script>().DecreaseWarrior5Hp(5);

                collision.GetComponentInParent<Warrior5Script>().BloodTxt.gameObject.SetActive(true);      //掉血文本特效
                collision.GetComponentInParent<Warrior5Script>().BloodTxt.text = "-" + "5";
                ...
                {
                    collision.GetComponent<Warrior6Script>().DecreaseWarrior6Hp(5);

                    collision.GetComponentInParent<Warrior6Script>().BloodTxt.gameObject.SetActive(true);      //掉血文本特效
                    collision.GetComponentInParent<Warrior6Script>().BloodTxt.text = "-" + "5";
    ...
    public void OnTriggerStay2D(Collider2D collision)
    {
        if ((collision.gameObject.tag == "Npc" || collision.gameObject.name == "Player") && collision.gameObject != this.transform.parent)
        {
            if(collision.gameObject.name == "Player")
            {
                collision.gameObject.GetComponent<PlayerScript>().StartCoroutine("DecreaseMatrix");

            }
            if (collision.gameObject.name == "Warrior1(Clone)" )
            {
                collision.gameObject.GetComponent<Warrior1Script>().StartCoroutine("DecreaseMatrix");
                
            }
            if (collision.gameObject.name == "Warrior2(Clone)" )
            {

                collision.gameObject.GetComponent<Warrior2Script>().StartCoroutine("DecreaseMatrix");
            }
            if (collision.gameObject.name == "Warrior3(Clone)")
            {

                collision.gameObject.GetComponent<Warrior3Script>().StartCoroutine("DecreaseMatrix");
            }
            if (collision.gameObject.name == "Warrior4(Clone)")
            {

                collision.gameObject.GetComponent<Warrior4Script>().StartCoroutine("DecreaseMatrix");
            }
            if (collision.gameObject.name == "Warrior5(Clone)")
            {
                collision.gameObject.GetComponent<Warrior5Script>().StartCoroutine("DecreaseMatrix");
            }
            if (collision.gameObject.name == "Warrior6(Clone)")
            {
                collision.gameObject.GetComponent<Warrior6Script>().StartCoroutine("DecreaseMatrix");
            }
        }
    ...
    public void OnTriggerExit2D(Collider2D collision)
    {
        if ((collision.gameObject.tag == "Npc" || collision.gameObject.name == "Player") && collision.gameObject != this.transform.parent)
        {
            if (collision.gameObject.name == "Player")
            {
                collision.gameObject.GetComponent<PlayerScript>().StopCoroutine("DecreaseMatrix");
            }
            if (collision.gameObject.name == "Warrior1(Clone)")
            {
                collision.gameObject.GetComponent<Warrior1Script>().StopCoroutine("DecreaseMatrix");

            }
            if (collision.gameObject.name == "Warrior2(Clone)")
            {

                collision.gameObject.GetComponent<Warrior2Script>().StopCoroutine("DecreaseMatrix");
            }
            if (collision.gameObject.name == "Warrior3(Clone)")
            {

                collision.gameObject.GetComponent<Warrior3Script>().StopCoroutine("DecreaseMatrix");
            }
            if (collision.gameObject.name == "Warrior4(Clone)")
            {

                collision.gameObject.GetComponent<Warrior4Script>().StopCoroutine("DecreaseMatrix");
            }
            if (collision.gameObject.name == "Warrior5(Clone)")
            {
                collision.gameObject.GetComponent<Warrior5Script>().StopCoroutine("DecreaseMatrix");
            }
            if (collision.gameObject.name == "Warrior6(Clone)")
            {
                collision.gameObject.GetComponent<Warrior6Script>().StopCoroutine("DecreaseMatrix");
            }
        }
