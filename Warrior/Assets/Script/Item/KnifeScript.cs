...
public class KnifeScript : MonoBehaviour
{
    ...
    public void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.gameObject.tag == "Npc" || collision.gameObject.name == "Player")
        {
            ...
            {
                collision.GetComponent<Warrior4Script>().DecreaseWarrior4Hp(20f);
            ...
            {
                if (this.transform.parent.GetComponentInParent<Warrior1Script>().m.GetComponent<MapScript>().dic.ContainsKey(this.transform.parent.parent.GetComponent<Warrior1Script>().Name))
            ...
            {
                if (this.transform.parent.GetComponentInParent<Warrior2Script>().m.GetComponent<MapScript>().dic.ContainsKey(this.transform.parent.parent.GetComponent<Warrior2Script>().Name))
            ...
            {
                if (this.transform.parent.GetComponentInParent<Warrior3Script>().m.GetComponent<MapScript>().dic.ContainsKey(this.transform.parent.parent.GetComponent<Warrior3Script>().Name))
            ...
            {
                if (this.transform.parent.GetComponentInParent<Warrior4Script>().m.GetComponent<MapScript>().dic.ContainsKey(this.transform.parent.parent.GetComponent<Warrior4Script>().Name))
            ...
            {
                if (this.transform.parent.GetComponentInParent<Warrior5Script>().m.GetComponent<MapScript>().dic.ContainsKey(this.transform.parent.parent.GetComponent<Warrior5Script>().Name))
            ...
            {
                if (this.transform.parent.GetComponentInParent<Warrior6Script>().m.GetComponent<MapScript>().dic.ContainsKey(this.transform.parent.parent.GetComponent<Warrior6Script>().Name))
